...
<body>
	<!-- 
		...
		영역에 저장된 속성을 제거하므로, 로그아웃에서 사용할 수 있다.
	 -->
	<h2>remove 태그</h2>
	<c:set var="pageVar" value="페이지 영역"/>
	<c:set var="pageVar" value="리퀘스트 영역1" scope="request"/>
	<c:set var="requestVar" value="리퀘스트 영역2" scope="request"/>
	...
	<h3>스코프 미지정, 같은 속성명 삭제 후 출력하기</h3>
	<ul>
		<li>페이지: ${pageVar }</li>
		<li>리퀘스트1: ${requestScope.pageVar }</li>
		<li>리퀘스트2: ${requestVar }</li>
