<%--
	...
	외부문서를 포함(include)할 때 사용
 --%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    
<%--
	선언부(Declaration): 스크립트렛이나 표현식에서
	사용할 메소드를 선언할 때 사용한다. 
	함수는 주로 중복하여 사용하는 경우가 많으므로
	src(자바영역)을 많이 사용한다.
 --%>
<%!
...
<body>
	...
	<%--
		스크립트릿(Scriptlet): 주로 JSP코드를 작성하고 실행할 때 사용하는 영역
	...
	%>
	<%--
		표현식(Expression): 변수를 웹브라우저상에 출력할 때 사용
		JS의 document.write()와 동일한 역할을 한다.
		표현식 사용시 주의할 점은 문장끝에 ;(세미콜론)을 생략해야 하는 것.
 	--%>
